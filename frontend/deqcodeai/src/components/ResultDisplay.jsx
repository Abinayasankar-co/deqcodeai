...
const ResultDisplay = ({ url, content,code}) => {
  ...
  <Row className="mb-4">
    <Col>
      <Card className="w-11/12 max-w-7xl h-[35rem] bg-gray-800 text-white shadow-lg rounded-lg">
        <Card.Header className="text-white font-bold text-center">
  ...
  <Row>
    <Col>
      <Card className="bg-gray-800 w-11/12 border-secondary py-4 text-white shadow-md rounded-lg">
        <Card.Header className="text-white font-bold text">Circuit Details</Card.Header>
        <Card.Body className="h-full flex items-center justify-center p-0">
          {content ? (
  ...
  <Row>
    <Col>
      <Card className="bg-gray-800 w-11/12 border-secondary py-4 text-white shadow-md rounded-lg">
        <Card.Header className="text-white fond-bold text-center">Code Editor</Card.Header>
        <Card.Body>
